...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False, semi_percent = 0.5):
        ...
        assert semi_percent <= 1 and semi_percent >= 0.1, "semi_percent is the percent of supervised samples of all training samples, and between 0.1 and 1"
            ...
            if self.use_progress_bar:
                with trange(self.num_batches_per_epoch) as tbar:
                    for b in tbar:
                        ...
                        l = self.run_iteration(self.tr_gen, True, data_unsup_generator=self.unsup_gen, epochs = self.epoch + 1)
